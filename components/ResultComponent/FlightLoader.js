...
export default function FlightSearchLoader({
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-b from-blue-50 to-white p-4">
      <div className="bg-white w-full max-w-3xl shadow-xl rounded-2xl p-6 text-center border border-gray-200">
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-sm text-gray-500 mt-1">
            We're searching the{" "}
            <span className="text-[#f97316] font-medium">best fares</span> for
            you...
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mt-8 px-2">
          ...
          <div className="flex flex-col items-center">
            <ArrowLeftRight className="w-6 h-6 text-[#f97316] mb-1" />
        ...
        <div className="grid grid-cols-3 gap-3 mt-6 text-center">
          ...
          <div>
            <Users className="w-5 h-5 text-[#f97316] mx-auto mb-1" />
        ...
        <div className="mt-8">
          <div className="w-full h-3 bg-gray-200 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-[#f97316] via-[#2563eb] to-[#0f172a] transition-all duration-300"
        ...
        <div className="mt-6">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-[#f97316] hover:bg-[#0f172a] text-white font-semibold px-6 py-3 rounded-lg shadow transition-all duration-200 w-full"
          >
